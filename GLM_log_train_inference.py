...
for j in range(int(r)):
    ...
    plt.savefig(cd+'/Updated_Selected_stations_log_TH_as_feature/Scaled_Gauss_log_'+str(j)+'.png',dpi=300,bbox_inches='tight')
    plt.close()
    ...
    Y_test.to_csv(cd+'/Updated_Selected_stations_log_TH_as_feature/Y_test_'+str(j)+'.csv')
    #Y_pred_train.to_csv(cd+'/Y_pred_train_'+str(j)+'.csv')
    Y_pred_test.to_csv(cd+'/Updated_Selected_stations_log_TH_as_feature/Y_pred_'+str(j)+'.csv')
...
Y_pred_test_all.to_csv(cd+'/Updated_Selected_stations_log_TH_as_feature/All_pred_test_GLM_log.csv', index = False)
Y_pred_train_all.to_csv(cd+'/Updated_Selected_stations_log_TH_as_feature/All_pred_train_GLM_log.csv', index = False)
Y_test_all.to_csv(cd+'/Updated_Selected_stations_log_TH_as_feature/All_obs_test_GLM_log.csv', index = False)
all_params.to_csv(cd+'/Updated_Selected_stations_log_TH_as_feature/Coeff_GLM_log_scaled.csv',index = False)
...
#FIXME
Tplot.axes.set_title("Feature coefficients of GLM-Log",
                    fontsize=16)
...
# output file name
#FIXME
plot_file_name="Scaled_coeff_GLM_log_61.jpg"
 
# save as jpeg
Tplot.figure.savefig(cd+'/Updated_Selected_stations_log_TH_as_feature/'+plot_file_name,bbox_inches='tight',
                    format='jpeg',
                    dpi=300)