...
for i in range(int(Trials)):
    ...
    Train_events_random.to_csv(cd+'/XGB_Training_storms_trial_'+str(i)+'.csv')
    Test_events=pd.DataFrame(Test_events)
    Test_events.columns=['Storm_ID']
    Test_events.to_csv(cd+'/XGB_Test_storms_trial_'+str(i)+'.csv')
...
BIAS_piled.to_csv(cd+'/BIAS_all_trials_XGB'+'.csv', index = False)
RMSE_piled.to_csv(cd+'/RMSE_all_trials_XGB'+'.csv', index = False)
CRMSE_piled.to_csv(cd+'/CRMSE_all_trials_XGB'+'.csv', index = False)
MAE_piled.to_csv(cd+'/MAE_all_trials_XGB'+'.csv', index = False)
